...
from models.cifar import SoftMaxRRSVM_Inception
from py_utils import dir_utils
from pt_utils import t_sets
import RRSVM.RRSVM as RRSVM
parser = argparse.ArgumentParser(description='PyTorch CIFAR Training on Softmax RRSVM Inception')
...
model = SoftMaxRRSVM_Inception.GoogLeNet(n_classes=n_classes, useRRSVM=True)
