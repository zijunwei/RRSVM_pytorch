...
from models.cifar import SoftMaxRRSVM_Densenet
from py_utils import dir_utils
from pt_utils import t_sets
import RRSVM.SoftMax_RRSVM as RRSVM
parser = argparse.ArgumentParser(description='PyTorch CIFAR Training on DensestNet')
parser.add_argument('--depth', default=100, type=int, help='depth of DenseNet')
parser.add_argument('--gr', default=12, type=int, help='growth rate of DenseNet')
...
identifier = 'SoftMaxRRSVMDenseNet{:d}_{:d}'.format(args.depth, args.gr)
...
model = SoftMaxRRSVM_Densenet.DenseNet3(depth=args.depth, growth_rate=args.gr, n_classes=n_classes, useRRSVM=True)
