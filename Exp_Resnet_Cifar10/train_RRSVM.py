...
default_model_directory = os.path.join(os.path.expanduser('~'), 'datasets/RRSVM_PretrainedModels/Cifar10')
dataset_root = (os.path.join(os.path.expanduser('~'), 'datasets', 'RRSVM_datasets'))
...
parser.add_argument('--resume', '-r', default='Y',  type=str2bool, metavar='PATH',
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        s_dir = os.path.dirname(filename)
        shutil.copyfile(filename, os.path.join(s_dir, 'model_best.pth'))
