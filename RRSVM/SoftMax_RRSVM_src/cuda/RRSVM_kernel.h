...
void SoftMax_updateOutput(cudaStream_t stream, const float* s_data, float* softmax_output, int kH, int kW, int nInputPlane);
void SoftMax_UpdateGradInput(cudaStream_t stream, const float* softmax_output, const float * gradSoftmax, float* gradS, int kH, int kW, int nInputPlane);
