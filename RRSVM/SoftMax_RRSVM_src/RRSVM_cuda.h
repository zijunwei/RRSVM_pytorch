...
void RRSVM_accGradParameters_cuda(THCudaTensor *input,THCudaTensor *softmax_s, THCudaLongTensor * indices, THCudaTensor *gradOutput, THCudaTensor *gradS, THCudaTensor *gradSgradSoftmax,
    int kW, int kH,
    int dW, int dH,
    int padW, int padH,
    int dilationW, int dilationH);
