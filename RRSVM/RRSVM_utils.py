...
# def load_for_finetune(model, state_dict, isRandom=False):
#     """Load parameters from a base network to the model with the same structure but everypooling replaced by else RRSVM
#
#     Arguments:
#         state_dict (dict): A dict containing parameters and
#             persistent buffers.
