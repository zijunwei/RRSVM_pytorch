...
class GoogLeNet(nn.Module):
    def __init__(self, n_classes=10, useRRSVM=False):
        ...
        if not self.useRRSVM:
            ...
            self.pool1 = RRSVM.RRSVM_Module(480, kernel_size=2, stride=2, return_indices=False)
            self.pool2 = RRSVM.RRSVM_Module(832, kernel_size=2, stride=2, return_indices=False)
            self.pool3 = RRSVM.RRSVM_Module(1024,kernel_size=8, stride=1, return_indices=False)
