...
cfg = {
    ...
    # 'VGG16_R_MO': [64, 'O', 'M', 128, 'O', 'M',  256, 256, 'O', 'M', 512, 512, 'O', 'M',  512, 512, 'O','M'],
    'VGG16_R_MO': [64, 'O', 128, 'O',  256, 256, 'O', 512, 512, 'O',  512, 512, 'O'],
...
class VGG(nn.Module):
    def __init__(self, vgg_name='VGG16_R_MO', n_classes=10, p_constraint=False):  # three different types: OWA, MAX, AVG
    ...
    def _make_layers(self, cfg):
        ...
        for x in cfg:
            if x == 'M':
                    ...
                    layers += [RRSVM.RRSVM_Module(in_channels, kernel_size=3, padding=1, stride=2)]
            else:
