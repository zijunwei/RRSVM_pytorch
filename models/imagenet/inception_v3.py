...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False, useRRSVM=False):
        ...
        if useRRSVM:
            self.pool2d_2b = RRSVM.RRSVM_Module(in_channels=64, kernel_size=3, stride=2)
        else:
        ...
        # 3 inception Fig 5
        if useRRSVM:
            self.pool2d_4a = RRSVM.RRSVM_Module(in_channels=192, kernel_size=3, stride=2)
        else:
...
class InceptionA(nn.Module):
    ...
    def __init__(self, in_channels, pool_features, useRRSVM=False):
        ...
        if useRRSVM:
            self.branch_pool_0 = RRSVM.RRSVM_Module(in_channels=in_channels, kernel_size=3, stride=1, padding=1)
        else:
...
class InceptionB(nn.Module):
    ...
    def __init__(self, in_channels, useRRSVM=False):
        ...
        if useRRSVM:
            self.branch_pool = RRSVM.RRSVM_Module(in_channels=in_channels, kernel_size=3, stride=2)
        else:
...
class InceptionC(nn.Module):
    ...
    def __init__(self, in_channels, channels_7x7, useRRSVM=False):
...
class InceptionD(nn.Module):
    ...
    def __init__(self, in_channels, useRRSVM=False):
        ...
        if useRRSVM:
            self.branch_pool =RRSVM.RRSVM_Module(in_channels, kernel_size=3, stride=2)
        else:
            self.branch_pool = nn.MaxPool2d(kernel_size=3, stride=2)
...
class InceptionE(nn.Module):
    ...
    def __init__(self, in_channels, useRRSVM=False):
        ...
        if useRRSVM:
            self.branch_pool_0 = RRSVM.RRSVM_Module(in_channels, kernel_size=3, stride=1, padding=1)
        else:
            self.branch_pool_0 = nn.AvgPool2d(kernel_size=3, stride=1, padding=1)
...
class InceptionAux(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, useRRSVM=False):
        ...
        if useRRSVM:
            self.pool = RRSVM.RRSVM_Module(in_channels, kernel_size=5, stride=3)
        else:
